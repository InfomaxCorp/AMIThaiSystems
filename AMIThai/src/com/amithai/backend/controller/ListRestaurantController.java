...
public class ListRestaurantController extends SelectorComposer<Component> {
	...
	public void showModal(Event e) {
		...
		Window window = (Window)Executions.createComponents(
				"/widgets/window/modal_dialog/restaurant_dialog.zul", null, null);
		window.doModal();
	}
...
@Listen("onClick = #editBtn")
	...
	public void showModalEdit(Event e) {
		...
		// create component
		Window window = (Window)Executions.createComponents(
				"/widgets/window/modal_dialog/edit_restaurant_dialog.zul", null, null);
